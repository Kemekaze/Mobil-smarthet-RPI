...
public class BtClientOLD implements DiscoveryListener, Runnable {
	
    private static BtClientOLD bt   = null;    
	...
	public static BtClientOLD get(){
		return (bt == null)?bt = new BtClientOLD():bt;
	}
	public void debugOn(){
		debug = true;
	}
